...
├─────────────────────────────────────────────────────┤
│  时间        │  源轴              │  译文轴           │  ← 双轴表格
│  00:15.200   │  ████████ 你好      │  ████████ Hello   │     行头=时间戳
│  00:18.400   │  ██████   谢谢      │  ██████ Thank you │     左列=源轴
│  00:22.000   │  ████████████████   │  ████████████████ │     右列=译文轴
│  00:25.600   │                    │                   │     颜色=持续时间
│  00:29.200   │  ██ 对             │  ██ sorry         │
│  00:32.800   │  ████████████ 不起  │  ████████████ about│
...
**内容组件：**
- `QTableWidget`：101行×2列动态表格（源轴 + 译文轴）
- 轴选择按钮组（高亮当前选中轴）
- 同步锁定按钮
- 间隔选择下拉框
- 操作按钮栏（合并/切割/拆分/导入/导出ASS/撤销/重做）

**交互：**
- 完整的快捷键支持（Q/W/E/R/5/Delete/Space/S/Tab/方向键等）
- 右键上下文菜单
- 双击编辑字幕文本
- 鼠标拖动跟随播放位置
- Tab 键切换当前活动轴
...
```
┌──────────────────────────────────────────────────────────────────────┐
│  📂打开  │  ▶播放  🔇静音  ━━━●━━━ 音量  │  00:00 / 05:30  │  ───●─── 进度条  │  1.0x▾  │  [1] [2] [🔒]  │  33ms▾  │  💾导出  │
└──────────────────────────────────────────────────────────────────────┘
```
